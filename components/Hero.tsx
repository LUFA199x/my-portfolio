...
// Photo data with positions/rotations for the collage effect
const photos = [
  {
    id: 1,
    src: 'https://picsum.photos/seed/portrait1/400/550',
  ...
  {
    id: 2,
    src: 'https://picsum.photos/seed/bw1/320/420',
  ...
  {
    id: 3,
    src: 'https://picsum.photos/seed/fashion1/280/360',
  ...
  {
    id: 4,
    src: 'https://picsum.photos/seed/outdoor1/260/330',
  ...
  {
    id: 5,
    src: 'https://picsum.photos/seed/studio1/320/420',
    alt: 'Studio shot',
    style: {
      width: 220,
      height: 290,
  ...
  {
    id: 6,
    src: 'https://picsum.photos/seed/business1/280/360',
  ...
  {
    id: 7,
    src: 'https://picsum.photos/seed/nature1/240/180',
    alt: 'Nature shot',
    style: {
      width: 190,
      height: 145,
  ...
  {
    id: 8,
    src: 'https://picsum.photos/seed/baby1/260/300',
    alt: 'Baby portrait',
    style: {
      width: 185,
      height: 215,
  ...
  {
    id: 9,
    src: 'https://picsum.photos/seed/top1/120/160',
    alt: 'Top photo',
    style: {
      width: 120,
      height: 140,
      ...
      <div ref={containerRef} className="collage-container max-w-5xl mx-auto px-4">
        {photos.map((photo, i) => (
          <div
            ...
            data-delay={i * 80}
            data-transform={`${photo.style.transform || 'none'}`}
            style={{
              ...photo.style,
              opacity: 0,
